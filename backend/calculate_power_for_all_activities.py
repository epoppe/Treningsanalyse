#!/usr/bin/env python3
"""
Script for å beregne power for alle løpeaktiviteter som ikke har power-verdier
"""
import sys
import os
...
def calculate_power_for_all_activities():
    """Beregn power for alle løpeaktiviteter som ikke har power-verdier"""
    
    print("🔋 STARTER POWER-BEREGNING FOR LØPEAKTIVITETER")
    print("=" * 60)
    ...
    try:
        ...
        # Hent alle løpeaktiviteter som ikke har power-verdier
        ...
        print(f"📊 Fant {total_activities} løpeaktiviteter uten power-verdier")
        
        if total_activities == 0:
            print("✅ Alle løpeaktiviteter har allerede power-verdier!")
            return
...
if __name__ == "__main__":
    calculate_power_for_all_activities()