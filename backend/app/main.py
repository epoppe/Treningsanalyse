...
from .routers import activities, analysis, analytics, garmin_data, health, readiness_v1, sync, training_readiness, training_stress, power, cache, bulk, factor_relationships, route_analysis, coaching_dashboard
...
app.include_router(coaching_dashboard.router)
