...
def recommend_next_session(
    ...
    with training_context() as (db, storage):
        from .coaching import recommend_next_session as _recommend
...
def classify_activity_session(
    ...
    with training_context() as (db, storage):
        from .coaching import classify_activity_session as _classify
...
def coaching_backtest_summary(
    ...
    """Historisk evaluering av coaching-signaler uten fremtidslekkasje."""
    with training_context() as (db, storage):
        from .coaching import coaching_backtest_summary as _backtest
