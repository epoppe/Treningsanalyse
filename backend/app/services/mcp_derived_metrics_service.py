...
DERIVED_METRIC_CATALOG: Dict[str, Dict[str, Any]] = {
    ...
    "running.critical_speed": {"category": "running", "unit": "km/h", "scope": "snapshot", "heuristic": False},
    ...
    "running.speed_30s_hist": {"category": "running", "unit": "km/h", "scope": "rolling_daily", "heuristic": False},
    "running.speed_1m_hist": {"category": "running", "unit": "km/h", "scope": "rolling_daily", "heuristic": False},
    "running.speed_3m_hist": {"category": "running", "unit": "km/h", "scope": "rolling_daily", "heuristic": False},
    "running.speed_5m_hist": {"category": "running", "unit": "km/h", "scope": "rolling_daily", "heuristic": False},
    "running.speed_10m_hist": {"category": "running", "unit": "km/h", "scope": "rolling_daily", "heuristic": False},
    "running.speed_20m_hist": {"category": "running", "unit": "km/h", "scope": "rolling_daily", "heuristic": False},
    "running.speed_40m_hist": {"category": "running", "unit": "km/h", "scope": "rolling_daily", "heuristic": False},
    "running.speed_60m_hist": {"category": "running", "unit": "km/h", "scope": "rolling_daily", "heuristic": False},
    ...
    "running.speed_30s": {"category": "running", "unit": "km/h", "scope": "snapshot", "heuristic": False},
    "running.speed_1m": {"category": "running", "unit": "km/h", "scope": "snapshot", "heuristic": False},
    "running.speed_3m": {"category": "running", "unit": "km/h", "scope": "snapshot", "heuristic": False},
    "running.speed_5m": {"category": "running", "unit": "km/h", "scope": "snapshot", "heuristic": False},
    "running.speed_10m": {"category": "running", "unit": "km/h", "scope": "snapshot", "heuristic": False},
    "running.speed_20m": {"category": "running", "unit": "km/h", "scope": "snapshot", "heuristic": False},
    "running.speed_40m": {"category": "running", "unit": "km/h", "scope": "snapshot", "heuristic": False},
    "running.speed_60m": {"category": "running", "unit": "km/h", "scope": "snapshot", "heuristic": False},
    ...
    "weather.adjusted_pace": {"category": "weather", "unit": "M:SS/km", "scope": "activity", "heuristic": True},
